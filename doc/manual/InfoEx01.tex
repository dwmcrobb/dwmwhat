...
Would produce a 67 byte string literal at compile time with the following
layout:
...
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim1) { };
\node[byte node,minimum width=7\onebyte,text width=7\onebyte,fill=white] (seg2) {\emoji{robot}\#};
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim2) { };
\node[byte node,minimum width=3\onebyte,text width=3\onebyte,fill=white] (seg3) {\emoji{white-check-mark}};
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim3) { };
\node[byte node,minimum width=7\onebyte,text width=7\onebyte,fill=white] (seg4) {DwmWhat};
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim4) { };
\node[byte node,minimum width=5\onebyte,text width=5\onebyte,fill=white] (seg5) {1.0.0};
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim5) { };
\node[byte node,minimum width=18\onebyte,text width=18\onebyte,fill=white] (seg6) {Daniel McRobb 2025};
\node[byte node,minimum width=2\onebyte,text width=2\onebyte, fill=white] (delim6) { };
