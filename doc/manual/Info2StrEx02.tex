...
\begin{Verbatim}
Dwm::What::Info(\textcolor{typeColor}{DWM_WHAT_TYPE_EXE}, \textcolor{statusColor}{DWM_WHAT_STATUS_REL}, \textcolor{nameColor}{"myprog"}, \textcolor{versionColor}{"0.9.3"},
                \textcolor{copyrightColor}{"Jane Doe 2025"}, \textcolor{otherColor}{"something!"})
\end{Verbatim}
...
\begin{tikzpicture}[
  ...
  \def\mysegfourstring{0,.,9,.,3}
  \def\mysegfivestring{J,a,n,e,{ },D,o,e,{ },2,0,2,5}
  \def\mysegsixstring{s,o,m,e,t,h,i,n,g,!}
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-33.south west) -- (byte-45.south east)
  ...
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-33.north west) -- (byte-45.north east)
    node [above=8pt, midway] {Jane Doe 2025};
  \foreach \byte [count=\i] in \mydelimstring {
    \node[byte node, text=delimColor, fill=white, font=\scriptsize\ttfamily, text depth=0pt] (byte-\arabic{lastbyte}) {\rotatebox{90}{\byte}};
    \stepcounter{lastbyte}    
  }
  \draw [decorate, decoration={brace, amplitude=10pt}]
  (byte-46.north west) -- (byte-47.north east)
  node [above=8pt, midway] {\textvisiblespace};
...
\begin{tikzpicture}[
  ...
  \def\mysegonestring{0x04,0x04,0x03,0x06,0x05,0x0D,0x0A}
...
\end{tikzpicture}
\label{figure:Info2Seg2StrEx02SegLen}
