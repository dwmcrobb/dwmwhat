...
for which I created macros in \texttt{DwmWhatMacros.hh}.  And for the
...
\input{Chapter_ClassTemplates.tex}

\input{Chapter_InfoExamples.tex}

\input{Chapter_SegLitExamples.tex}
