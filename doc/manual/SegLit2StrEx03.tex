...
% anchor=south, 
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-5.south west) -- (byte-7.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(1)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-5.north west) -- (byte-7.north east)
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-8.south west) -- (byte-10.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(2)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
  (byte-8.north west) -- (byte-10.north east)
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-11.south west) -- (byte-16.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(3)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-11.north west) -- (byte-16.north east)
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-17.south west) -- (byte-20.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(4)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-17.north west) -- (byte-20.north east)
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-21.south west) -- (byte-23.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(5)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-21.north west) -- (byte-23.north east)
    node [above=8pt, midway] {the};
  ...
  \draw [decorate, decoration={brace, mirror, amplitude=10pt}]
    (byte-24.south west) -- (byte-27.south east)
    node [below=8pt, midway, font=\scriptsize] {\texttt{nth(6)}};
  \draw [decorate, decoration={brace, amplitude=10pt}]
    (byte-24.north west) -- (byte-27.north east)
  ...
  \draw [decorate, decoration={brace,mirror,amplitude=20pt,raise=20pt}]
    (byte-1.south west) -- (byte-27.south east)
    node [below=40pt, midway, font=\scriptsize] {\texttt{view()}};
    
\end{tikzpicture}
\label{figure:SegLit2StrEx03}
\end{center}
...
\end{tikzpicture}
\label{figure:SegLit2StrEx03SegLen}

\vspace{1em}
For a total of 35 bytes: 28 for the compile-time string and 7 for the array of
segment lengths.
